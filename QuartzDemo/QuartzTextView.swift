...
class QuartzTextView: QuartzView {
    ...
    override func drawInContext(_ context: CGContext) {
        ...
        lineText.addAttribute(NSAttributedString.Key.font, value: demoFont!, range: NSMakeRange(0, lineText.length))
//        lineText.addAttribute(NSAttributedString.Key.foregroundColor, value: true, range: NSMakeRange(0, lineText.length))
